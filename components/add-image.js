    ...
    return (
      <div className='fr w-50 w-third-ns'>
        <input hidden name="id" value={this.state.id} readOnly />
          ...
          {this.state.imageUrl &&
            <button className='tofino w-100 fw4 ph3 pv2 input-reset ba bg-dark-gray near-white hover-bg-red b--white pointer f6' onClick={this.handlePost}>Save to entry</button>
          }
      </div>
    )
  }
