...
const Header = ({pathname}) => (
  <header role="banner" className="fixed-ns vh-100-ns w-100 w5-ns bg-near-white dark-gray top-0 left-0 flex content-center justify-center flex-column border-box pa4 pb0 pb4-ns">
    <header className="items-start flex-auto">
      <Logo/>
      <h1 className="fl w-80 ma0 w-100-ns f5 f4-ns lh-title fw6 pl3 pl0-ns"><Link href="/" prefetch><a className="link dark-gray hover-red hover-red">Untitled Col<br/>Database Project</a></Link></h1>
      <Nav pathname={pathname}/>
    </header>
    <footer className="lh-copy dn db-ns">
